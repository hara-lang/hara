use super::super::graph::UnitKind;
...
pub(super) fn unit_kind(form: &Form) -> UnitKind {
    match list_head(without_metadata(form)) {
        Some("defmacro") => UnitKind::Macro,
        Some("defprotocol" | "extend-type" | "defmulti" | "defmethod" | "defstruct"
        | "defmutable") => UnitKind::Registration,
