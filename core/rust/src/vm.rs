...
pub use bundle::{
    compile_bytecode_bundle, compile_embedded_standard_library_bundle, encode_bytecode_bundle,
    eval_bytecode_bundle, eval_eager_bytecode_bundle_with_registries, BytecodeBundleModule,
    ModuleSource,
};
