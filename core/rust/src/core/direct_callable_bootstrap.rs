/// Bootstrap callables discovered by the exhaustive fiber/catalog gate after
/// the base catalog landed. They are part of the same logical closed catalog;
/// the small partition keeps the corrective slice isolated from unrelated
/// generated inventory and #648/#844 work.
