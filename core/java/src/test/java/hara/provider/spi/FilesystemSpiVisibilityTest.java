...
/** Compile-time proof that independently loaded provider JARs can consume the trusted filesystem SPI. */
public class FilesystemSpiVisibilityTest {
  @Test
  public void providerPackageCanUseCanonicalPathsCapabilitiesMutationsAndCallLifecycle() throws Exception {
