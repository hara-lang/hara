  ...
  private static int operandCount(HbcProgram.Opcode opcode) {
    return switch (opcode) {
      ...
      case CONSTANT, LOAD_LOCAL, STORE_LOCAL, JUMP, JUMP_IF_FALSE, CALL, GET_GLOBAL, SET_GLOBAL,
          ...
          CONCAT_LIST, PRIMITIVE_VALUE, BUILTIN_VALUE, DYNAMIC_BIND, DYNAMIC_UNBIND,
          DEF_PROTOCOL, EXTEND_TYPE, DEF_MULTI, DEF_METHOD -> 1;
      case PRIMITIVE, CLOSURE, CALL_STATIC, DEF_GLOBAL, DEF_STRUCT, MAKE_MULTI_ARITY, DEF_MACRO -> 2;
      case DOT_CALL -> 2;
