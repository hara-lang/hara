...
old = '''/// Returns namespace resources from the automatically selected native Rust profile.
...
'''
new = '''#[path = "project/resources.rs"]
mod resources;
pub use resources::source_resources;

'''
if source.count(old) != 1:
    raise SystemExit("expected one inline source_resources implementation")
