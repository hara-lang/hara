...
pub trait Guest {
    fn render(source: _rt::String) -> _rt::String;
}
#[doc(hidden)]
macro_rules! __export_world_markdown_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "render")] unsafe extern "C" fn
        export_render(arg0 : * mut u8, arg1 : usize,) -> * mut u8 { unsafe {
        $($path_to_types)*:: _export_render_cabi::<$ty > (arg0, arg1) } } #[unsafe
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:hara:markdown@0.1.0:markdown:encoded world"
)]
#[doc(hidden)]
...
@\x01\x06sources\0s\x04\0\x06render\x01\0\x04\0\x1chara:markdown/markdown@0.1.0\x04\
\0\x0b\x0e\x01\0\x08markdown\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
